...
public class TestPeople {
	...
	public static void main(String[] args) {
		...
		Person bPerson = new Boy(); // Strict
		// Boy boy = new Boy();
		// Person bPerson = (Person) boy;
		/* When downcasting, we instantiate a parent object using the constructor of the child
		 * and then casting as a child
		 * Or we can create a FULL child object 
		 * and then create a parent object and assigning the child to it cast as the parent
		 */
		System.out.println(((Boy) bPerson).talk());
